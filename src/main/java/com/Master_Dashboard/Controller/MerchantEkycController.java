...
public class MerchantEkycController {
	...
	public Map<String, Object> merchantAadhaarGenerateOtp(@RequestHeader("Client-Id") String clientId,
			@RequestHeader("Client-Secret") String clientSecret, @PathVariable("aadhaar") String aadhaar) {
	...
	public Map<String, Object> merchantAadhaarValidateOtp(@RequestHeader("Client-Id") String clientId,
			@RequestHeader("Client-Secret") String clientSecret, @Valid @RequestBody ValidateOtp validateOtp) {
		...
		try {
			...
			response = merchantEkycService.validateOtp(validateOtp.getOtp(), validateOtp.getMermerchantTrxnRefId(),
	...
	public Map<String, Object> merchantPanVerify(@RequestHeader("Client-Id") String clientId,
			@RequestHeader("Client-Secret") String clientSecret, @PathVariable("pan") String pan) {
